...
<div class="row">
	<div class="col-md-6">
		<div class="form-group"><label class="col-sm-4 control-label">USERNAME</label>
			<div class="col-sm-8"><?=form_input(array('name'=>'username','id'=>'username','class'=>'form-control', 'value'=>$row->USERNAME));?></div>
		</div>
	</div>
</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-8">
				<?php $data = array('1'=>'Aktif', '0'=>'Tidak Aktif');
					echo form_dropdown('status',$data,'','id="status" class="form-control"', $row->ISACTIVE);
				?>
			</div>
		</div>
	</div>
