...
WHERE s.id_cab=".$cabang->ID_CAB." AND J.id_div NOT IN (SELECT id_div FROM mst_divisi WHERE (id_div_parent IN (1,2)) OR (id_div IN (1,2))) AND j.id_div<>1")->result();
				...
				foreach ($rsDiv as $rsUsaha){
					...
					$htmlU.="<tr><td COLSPAN=2>".$rsUsaha->NAMA_DIV."</td>";				
					$htmlU.= "<td>Rp.&nbsp;".number_format($usahaPayroll->KEL1,2,',','.')."</td>";
					$htmlU.= "<td>Rp.&nbsp;".number_format($usahaPayroll->KEL2,2,',','.')."</td>";
					$htmlU.= "<td>Rp.&nbsp;".number_format($usahaPayroll->KEL_ANYAR,2,',','.')."</td>";
					$htmlU.= "<td>Rp.&nbsp;".number_format($usahaPayroll->KEL3,2,',','.')."</td>";
					$htmlU.= "<td>Rp.&nbsp;".number_format($usahaPayroll->KEL4,2,',','.')."</td>";
					$htmlU.= "<td>Rp.&nbsp;".number_format($usahaPayroll->KEL5,2,',','.')."</td>";
					$htmlU.= "<td>Rp.&nbsp;".number_format($usahaPayroll->KEL6,2,',','.')."</td>";	
					$htmlU.= "<td>Rp.&nbsp;".number_format($usahaPayroll->KEL7,2,',','.')."</td>";
					$htmlU.= "<td>Rp.&nbsp;".number_format($usahaPayroll->KEL8,2,',','.')."</td>";
					$htmlU.= "<td>Rp.&nbsp;".number_format($TOTAL,2,',','.')."</td>";	
