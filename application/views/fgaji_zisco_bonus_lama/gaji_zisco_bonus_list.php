...
<?	//echo "<tr align=center><td colspan=\"".$colspanAll."\">$str</td></tr>";
	if (sizeof($row)==0){	
		...
		//hari kerja ambil dari database
			...
			$skerja="select * from rekap_absensi_zisco where periode='".$thn_pre.$bln_pre."' and nik='".$hasil->NIK."'";
...
?>
	<tr>
		...
		<td bgcolor="#ffffcc"><input type="text" name="zisco_mundur_<?=$i?>" id="zisco_mundur_<?=$i?>" value="0" onkeyup="goPengembalian40(this, <?=$i?>)"></td>			
...
AND CONCAT(b.year, b.month)='".$thn_pre.$bln_pre."' AND b.zisco_id=".$hasil->ID."
...
$insi_zakat_wakaf_tunai=round($insi_infaq_paid + $rutin_zakat_selisih + $insi_zakat_paid + $insi_wakaf_icmb + $insi_wakaf_stainim + $insi_wakaf_masjid + $non_wakaf_quran + $non_wakaf_bencana + $non_wakaf_fidyah);
...
//zakat =IF(AO85<=3203846;AO85*0;IF(AO85>=3203846;AO85*2,5%))
...
<td bgcolor="#ffffcc"><?=form_input(array('name'=>'bonus_patungan_sapi_'.$i,'id'=>'bonus_patungan_sapi_'.$i,'class'=>'myform-control','size'=>10, 'value'=>0, "onkeyup"=>"countRevenue(".$i.", this)", "onkeypress"=>"return numericVal(this,event)"  ));?></td>
<td bgcolor="#ffffcc"><?=form_input(array('name'=>'bonus_qurban_sapi_'.$i,'id'=>'bonus_qurban_sapi_'.$i,'class'=>'myform-control','size'=>10, 'value'=>0, "onkeyup"=>"countRevenue(".$i.", this)", "onkeypress"=>"return numericVal(this,event)" ));?></td>
<td bgcolor="#ffffcc"><?=form_input(array('name'=>'koreksi_'.$i,'id'=>'koreksi_'.$i,'class'=>'myform-control','size'=>10, 'value'=>0, "onkeyup"=>"countRevenue(".$i.", this)", "onkeypress"=>"return numericVal(this,event)" ));?></td>
...
<td bgcolor="#ffffcc"><?=form_input(array('name'=>'pengembalian_40_'.$i,'id'=>'pengembalian_40_'.$i,'class'=>'myform-control','size'=>10, 'value'=>0, "readonly"=>true ));?></td>
...
<?=form_input(array('name'=>'angsuran_'.$i,'id'=>'angsuran_'.$i,'class'=>'myform-control','size'=>10, 'value'=>0, "readonly"=>true ));?></td>
<td bgcolor="#ffffcc"><?=form_input(array('name'=>'lain_lain_'.$i,'id'=>'lain_lain_'.$i,'class'=>'myform-control','size'=>10, 'value'=>0,  "onkeyup"=>"countExpense(".$i.", this)", "onkeypress"=>"return numericVal(this,event)" ));?></td>
