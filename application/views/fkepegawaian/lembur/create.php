		...
		<tbody>
			<tr class="info">
				...
				<td class="form-inline">
					<?php echo form_dropdown('mulai_h[]',range(00,23),16,' class="form-control" style="width:50px"');?> <label> :</label> 
					<?php echo form_dropdown('mulai_m[]',range(00,59),0,' class="form-control" style="width:50px"');?>
				</td>
				<td class="form-inline">
					<?php echo form_dropdown('selesai_h[]',range(00,23),16,' class="form-control" style="width:50px"');?> <label> : </label>
					<?php echo form_dropdown('selesai_m[]',range(00,59),0,' class="form-control" style="width:50px"');?>
				</td>
				<td>
