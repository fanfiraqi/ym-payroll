<?php echo form_open('payroll_staff/ubudiah_entry',array('class'=>'form-horizontal','id'=>'myform'));?>
<div class="row">	
	<div class="col-xs-12">
		...
		<div class="row">
			<div class="col-xs-12">
				<div class="form-group"><label  class="col-sm-4 control-label">DIVISI</label>
					<div class="col-sm-8"><?=form_dropdown('id_divisi',$divisi,'','id="id_divisi" class="form-control" disabled');?>
				</div>
			</div>
		</div>		
		<div class="row">
