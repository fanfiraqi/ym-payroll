<?php echo form_open('payroll_staff/save_daily_report',array('class'=>'form-horizontal','id'=>'myform'));?>
 <div class="row">
	<div class="col-xs-12">
...
$i=1;
	...
	foreach($row as $hasil){ 
		$jmlHari=0;
		$strGet="select JML_HARI from daily_report where bln='".$digitBln."' and thn='".$thn."' and nik='".$hasil->NIK."'";
...
$('#myform').submit(function(event) {
	$(this).saveForm('<?php echo base_url('payroll_staff/save_daily_report');?>','<?php echo base_url('payroll_staff/daily_report');?>');
