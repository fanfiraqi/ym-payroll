<?php echo form_open('gaji_staf/staff_payroll_list',array('class'=>'form-horizontal','id'=>'myform'));?>
<div class="row">	
	<div class="col-xs-12">
...
$('#id_cabang').change(function(){
	//alert($('#id_cabang').val());
	$.ajax({
		url: "<?php echo base_url('gaji_staf/comboDivByCab'); ?>",
		dataType: 'json',
		type: 'POST',
		...
		success: function(respon){
			...
			if (respon.status==1){
				...
				bootbox.dialog('Cabang ini belum memiliki divisi');
